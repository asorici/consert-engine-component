...
public class SenseSkeletonSittingEvent extends ContextEvent {
	...
	private Resource skeleton;
	
	public SenseSkeletonSittingEvent(Calendar timestamp, int validity, Resource camera, Resource skeleton) {
	...
	public UpdateRequest createUpdateRequest() {
		...
		Resource assertionClass = ADHOC.SENSES_SKELETON;
		
		Node graphURINode = Node.createURI(ContextModelUtils.createUUID(assertionClass));
		
		Resource sittingPosition = ADHOC.SITTING_POSITION;
		Property cameraRole = ADHOC.kinectCameraRole; 
		Property skeletonRole = ADHOC.skeletonRole;
		Property skelPositionRole = ADHOC.skelPositionRole; 
	...
	private Update createAnnotationUpdate(Node graphURINode, Calendar timestamp, int validity) {
		...
		// create update quads
		Node storeURINode = Node.createURI(ContextModelUtils.getAssertionStoreURI(assertionClass.getURI()));
